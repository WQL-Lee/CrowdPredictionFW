...
from pred_model.AGCRN.AGCRNCell import AGCRNCell
...
class AGCRN(nn.Module):
    def __init__(self, num_nodes, input_dim, hidden_dim, output_dim, cheb_k, embed_dim, horizon, num_layers, default_graph = True):
