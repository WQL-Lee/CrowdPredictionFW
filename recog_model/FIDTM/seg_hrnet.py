...
def get_seg_model(train=False):
    from recog_model.FIDTM.default import _C as hr_config
    from recog_model.FIDTM.default import update_config

    update_config(hr_config, 'recog_model/FIDTM/seg_hrnet_w48.yaml')
    model = HighResolutionNet(hr_config)
    from recog_model.FIDTM.config import cfg
